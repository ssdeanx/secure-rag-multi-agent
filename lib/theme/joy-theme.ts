 ...
 */
const supabaseGreen = {
    50: 'hsla(153, 99%, 95%, 1)', // Lightest tint
    100: 'hsla(153, 99%, 85%, 1)', // Very light
    200: 'hsla(153, 99%, 75%, 1)', // Light
    300: 'hsla(151, 99.7%, 70.0%, 1)', // Light-medium
    400: 'hsla(152, 99.9%, 65%, 1)', // Medium (close to base)
    500: 'hsla(152, 99.9%, 60%, 1)', // Base color hsl(153 60% 53%)
    600: 'hsla(152, 99.7%, 60%, 0.470)', // Darker
    700: 'hsla(152, 99.9%, 60%, 0.289)', // Much darker
    800: 'hsla(152, 98.7%, 60%, 0.125)', // Very dark
    900: 'hsla(152, 100%, 66.5%, 0.056)', // Darkest
}
...
const neutralPalette = {
    50: 'hsla(211, 86.7%, 99.6%, 1)', // --color-background light
    100: 'hsla(211, 86.7%, 99.6%, 1)', // Very light gray
    200: 'hsla(211, 86.7%, 98.8%, 1)', // --color-border light
    300: 'hsla(0, 0%, 100%, 0.5882352941176471)', // Light gray
    400: 'hsla(0, 0%, 100%, 0.38823529411764707)', // Medium gray
    500: 'hsla(0, 0%, 100%, 0.38823529411764707)', // --color-muted-foreground
    600: 'hsla(0, 0%, 100%, 0.16862745098039217)', // Dark gray
    700: 'hsla(0, 0%, 100%, 0.10196078431372549)', // Darker
    800: 'hsla(0, 0%, 100%, 0.03137254901960784)', // --color-background dark
    900: 'hsla(0, 0%, 100%, 0.03137254901960784)', // Darkest
}
...
const dangerPalette = {
    ...
    200: 'hsla(358, 100%, 69.7%, 0.980)',
    300: 'hsla(358, 100%, 67.5%, 0.942)',
...
const successPalette = {
    50: 'hsla(181, 84%, 90%, 1)',
    100: 'hsla(181, 84%, 80%, 1)',
    200: 'hsla(181, 84%, 70%, 1)',
    300: 'hsla(181, 84%, 55%, 1);',
    400: 'hsla(181, 84%, 45%, 1);',
    500: 'hsla(181, 84%, 39%, 1);', // Close to base hsl(181 84% 39%)
    600: 'hsla(212, 99.9%, 51.7%, 1)',
    700: 'hsla(212, 99.9%, 51.7%, 0.323)',
    800: 'hsla(212, 99.9%, 51.7%, 0.184);',
    900: 'hsla(212, 99.9%, 51.7%, 0.045);',
}
...
const warningPalette = {
    50: 'hsla(54, 99%, 95%, 1);',
    100: 'hsla(54, 99%, 85%, 1);',
    200: 'hsl(54, 100%, 75.0%, 1)',
    300: 'hsla(53, 100%, 59.0%, 1)',
    400: 'hsla(50, 100%, 50%, 1)', // Base hsl(42 96% 50%)
    500: 'hsla(50, 100%, 38.0%, 0.980)',
    600: 'hsla(50, 99.8%, 44.6%, 0.577)',
    700: 'hsla(50, 99.9%, 49.5%, 0.357)',
    800: 'hsla(50, 100%, 13.4%, 1)',
    900: 'hsla(52, 100%, 4.6%, 1)',
}
