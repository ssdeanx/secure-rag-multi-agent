...
export function buildBaseMetadata(partial: Partial<Metadata> = {}): Metadata {
  return {
    title: SITE_NAME,
    description: 'Secure governed RAG system with hierarchical RBAC and zero-trust retrieval.',
...
export function metadataFromFrontmatter(fm: FrontmatterLike, slugPath: string): Metadata {
