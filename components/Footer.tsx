...
export function Footer({ className }: { className?: string }) {
    return (
        <footer
            className={cn(
                'mt-20 border-t border-border/60 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/75',
                className
            )}
        >
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid gap-10 md:grid-cols-4">
                    <div className="space-y-4">
                        ...
                        <p className="text-sm text-muted-foreground leading-relaxed">
                            Secure, role-aware Retrieval-Augmented Generation
                            with multi-agent governance and enterprise-grade
                            auditability.
                        </p>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-6 text-sm">
                    ...
                    <p className="text-muted-foreground text-center md:text-right">
                        © {new Date().getFullYear()} Governed RAG. All rights
                        reserved.
                    </p>
                </div>
            </div>
