  ...
  return (
    ...
    >
      <div className="space-y-2">
        <label htmlFor="auth-email" className="block text-sm font-semibold text-foreground">Email Address</label>
        <input
          id="auth-email"
          name="email"
          type="email"
      ...
      <div className="space-y-2">
        <label htmlFor="auth-password" className="block text-sm font-semibold text-foreground">Password</label>
      ...
      <div className="space-y-2">
        <label htmlFor="auth-role" className="block text-sm font-semibold text-foreground">Access Role</label>
        <select
          id="auth-role"
          value={role}
