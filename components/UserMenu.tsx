    ...
    return (
        <DropdownMenu>
            ...
            >
                ...
                <div
                    className={cn(
                        'px-6 py-4 border-b-2 border-primary/20 bg-accent/5'
                    )}
                >
                    <div className={cn('flex items-center space-x-3')}>
                        ...
                        <div className={cn('flex flex-col flex-1')}>
                            ...
                            <div className={cn('mt-2 space-y-1')}>
                                ...
                                <Progress
                                    value={getRoleProgress(currentRole)}
                                    className={cn('h-2')}
                                />
                            </div>
                        </div>
                ...
                <div className={cn('p-2')}>
                    <DropdownMenuItem asChild>
                        ...
                        >
                            <div className={cn('flex items-center w-full')}>
                                <Settings
                                    className={cn(
                                        'mr-3 h-5 w-5 transition-all duration-300 group-hover/item:rotate-90 group-hover/item:scale-110 text-foreground'
                                    )}
                                />
                                <span
                                    className={cn(
                                        'font-bold text-foreground group-hover/item:text-accent transition-colors duration-300'
                                    )}
                                >
                                    Settings
                                </span>
                    ...
                    <DropdownMenuSeparator
                        className={cn('bg-primary/20 my-2')}
                    />
                    ...
                    >
                        <div className={cn('flex items-center w-full')}>
                            <LogOut
                                className={cn(
                                    'mr-3 h-5 w-5 transition-all duration-300 group-hover/item:scale-110 group-hover/item:-rotate-12 text-destructive'
                                )}
                            />
                ...
                <div
                    className={cn(
                        'absolute bottom-2 right-2 w-4 h-4 bg-accent/20 rounded-full blur-sm animate-pulse'
                    )}
                />
            </DropdownMenuContent>
        </DropdownMenu>
