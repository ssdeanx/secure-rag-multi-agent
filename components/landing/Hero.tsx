        ...
        >
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
                ...
                >
                    ...
                    >
                        <Button
                            size="lg"
                            className="group text-lg px-8 py-6 h-auto bg-primary hover:bg-primary/90 transition-all duration-200 shadow-xl shadow-primary/20 hover:shadow-2xl hover:shadow-primary/30 hover:scale-105"
                            asChild
                        >
                            <a
                                href="/demo-rag"
            ...
            >
                <div className="w-6 h-10 border-2 border-primary/30 rounded-full flex justify-center">
                    {prefersReducedMotion ? (
                        <span className="w-1 h-3 bg-primary rounded-full mt-2" />
                    ) : (
                        <motion.div
                            animate={{ y: [0, 12, 0] }}
