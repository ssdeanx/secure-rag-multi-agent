...
import { Box, Typography, Card, CardContent, Chip, Grid, Stack } from '@/components/ui/joy'
import {
    Security,
    Psychology,
    Edit,
...
const coreCapabilities = [
    {
        ...
        description: 'Multi-agent security pipeline with hierarchical RBAC, document classification, and compliance validation.',
        highlights: ['6-stage validation pipeline', 'Role inheritance system', 'Audit-ready logging'],
    ...
    },
    {
        ...
        highlights: ['Multi-format content creation', 'Quality evaluation system', 'Iterative improvement'],
        color: 'primary' as const,
    },
    {
        icon: <Search sx={{ fontSize: 32 }} />,
        title: 'Advanced Research & Analysis',
        description: 'Comprehensive research capabilities with web scraping, data synthesis, and automated reporting.',
        highlights: ['2-phase research process', 'Web data extraction', 'Automated report generation'],
    ...
    },
    {
        ...
        highlights: ['Feature hierarchy tracking', 'Community voting system', 'Status progression workflow'],
        color: 'info' as const,
    },
    {
        ...
        highlights: ['Document chunking pipeline', 'Vector embeddings', 'Access-controlled retrieval'],
    ...
    },
    {
        ...
        highlights: ['Google Sheets integration', 'Weather data services', 'Graph RAG queries'],
        color: 'primary' as const,
    },
]
...
const orchestrationStats = [
    ...
    { label: '11+ Orchestrated Workflows', icon: <AutoAwesome />, value: '11+' },
    { label: 'Multi-Agent Networks', icon: <IntegrationInstructions />, value: '∞' },
]
            ...
            <Box sx={{ maxWidth: '1400px', mx: 'auto', px: { xs: 2, sm: 4 } }}>
                ...
                >
                    <Box sx={{ textAlign: 'center', mb: 8 }}>
                        ...
                        >
                            Built on Mastra's multi-agent architecture with specialized agents,
                            secure tools, and orchestrated workflows for complex enterprise automation.
                        </Typography>
                    </Box>
                </motion.div>
                ...
                >
                    <Box sx={{ textAlign: 'center' }}>
                        ...
                        >
                            Join organizations leveraging Mastra for secure, intelligent automation
                            with complete governance and compliance.
                        </Typography>
                    </Box>
                </motion.div>
            </Box>
