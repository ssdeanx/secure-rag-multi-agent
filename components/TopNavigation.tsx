    ...
    return (
        <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/90 backdrop-blur-md supports-[backdrop-filter]:bg-background/70">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center gap-4">
                <nav
                    className="hidden md:flex flex-1 items-center space-x-4"
                        ...
                        <div className="flex items-center">
                            <MenubarMenu>
                                ...
                                >
                                    <Link
                                        href="/"
                                        className="no-underline text-balance inline-flex items-center"
                                    >
                                        <span className="text-xl tracking-tight font-extrabold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
                                            Deanmachines
                                        </span>
                                    </Link>
                                </MenubarTrigger>
                                    ...
                                    <MenubarMenu key={link.href}>
                                        ...
                                        >
                                            <Link
                                                ...
                                                className="no-underline px-2 py-1 rounded-md focus-visible:ring-2 focus-visible:ring-primary/50"
                                            >
                                                {link.label}
                                            </Link>
                                        </MenubarTrigger>
                        ...
                        <div className="flex items-center gap-2">
                            <MenubarMenu>
                                <MenubarTrigger asChild className="btn-ghost">
                                    <div className="px-1 py-1 rounded-md focus-visible:ring-2 focus-visible:ring-primary/50">
                                        <ThemeToggle />
                                    </div>
                                </MenubarTrigger>
                            </MenubarMenu>
