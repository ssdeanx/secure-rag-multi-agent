    ...
    <section aria-labelledby="team-heading" className="py-20 bg-muted/30">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-10 space-y-3">
          <h2 id="team-heading" className="text-3xl font-bold tracking-tight">Team</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            A focused group of engineers and researchers building the future of governed AI.
          </p>
        </div>
        <ul className="grid gap-8 sm:grid-cols-2 md:grid-cols-4" aria-label="Team members">
          {team.map((member, i) => (
