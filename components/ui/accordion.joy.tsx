...
export const AccordionGroup = React.forwardRef<HTMLDivElement, AccordionGroupProps>(
  ({ children, sx, variant = 'outlined', color = 'neutral', size = 'md', disableDivider, className, ...props }, ref) => {
    return (
      <JoyAccordionGroup
        ref={ref}
        sx={sx}
...
export const Accordion = React.forwardRef<HTMLDivElement, AccordionProps>(
  ({ children, sx, disabled, expanded, defaultExpanded, onChange, className, ...props }, ref) => {
    return (
      <JoyAccordion
        ref={ref}
        sx={sx}
