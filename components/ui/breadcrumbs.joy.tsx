...
import { Breadcrumbs as JoyBreadcrumbs, Link as JoyLink, Typography } from '@mui/joy'
...
export const Breadcrumbs = React.forwardRef<HTMLOListElement, BreadcrumbsProps>(
  ({ children, separator = '/', sx, size = 'md', className, ...props }, ref) => {
    return (
      <JoyBreadcrumbs
        ref={ref}
        separator={separator}
...
export const BreadcrumbPage = React.forwardRef<HTMLSpanElement, { children: React.ReactNode; sx?: SxProps; className?: string }>(
