...
```mermaid
graph TB
    UI[Frontend<br/>Next.js + React]
    Auth[JWT Auth<br/>@mastra/auth]
    Mastra[Mastra Core<br/>Agent Orchestration]
    Agents[16+ AI Agents<br/>Reasoning Units]
  ...
  <Card variant="outlined">
    ...
    <CardContent>
      <Typography level="body-sm">
        • Multi-modal chat interfaces<br/>
