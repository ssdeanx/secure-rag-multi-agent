...
description: Guide for developers to build interactive UI components in Cedar-OS and integrate with Mastra backend for the Multi-Domain AI Orchestration Platform.
---
...
This guide provides a detailed onboarding process for developers looking to build interactive UI components within `cedar-os` and integrate them with the powerful AI-driven capabilities of the Multi-Domain AI Orchestration Platform.

## 1. Overall Architecture and Interaction Flow

At a high level, the system consists of a frontend built with `cedar-os` (a React-based framework) and a backend powered by the Multi-Domain AI Orchestration Platform (a Next.js application leveraging a sophisticated agentic workflow engine). They communicate primarily via HTTP/REST APIs, secured by JWTs.
...
- **Mastra-Governed-RAG (Backend)**:
    - **Purpose**: Processes natural language queries across 5 capability domains using 27 specialized agents.
    ...
    - **Mastra Agents**: Specialized AI components (`src/mastra/agents/`) performing distinct tasks across 5 domains: Governed RAG, Deep Research, Financial Intelligence, Content Generation, and Interactive State Management.
...
graph TD
    ...
    subgraph mastraPlatform["Multi-Domain AI Orchestration Platform<br>[Backend]"]
