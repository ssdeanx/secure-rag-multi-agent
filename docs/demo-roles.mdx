...
This page demonstrates role-based access control in the Multi-Domain AI Orchestration Platform using sample queries against the corpus documents. Use the UI's AuthPanel or `scripts/make-jwt.js` to generate JWTs for testing different access scenarios.
...
<Alert className="mb-6">
    ...
    <AlertDescription>
        ...
        provides appropriate responses based on user permissions across all 5 capability domains.
    </AlertDescription>
</Alert>
