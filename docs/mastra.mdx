...
<Tabs defaultValue="system">
  ...
  <TabsContent value="system">
    ...
    <Box component="ul" sx={{ ml: 3, '& li': { mb: 1 } }}>
      ...
      <li><strong>Agents</strong> — 16+ specialized agents for retrieval, research, content generation, evaluation, and more.</li>
      ...
      <li><strong>Storage</strong> — LibSQL for metadata and conversation storage with built-in vector support.</li>
...
`} />
  ...
  <TabsContent value="agents">
    <Typography sx={{ fontSize: '1.125rem', fontWeight: 'bold', mb: 2 }}>Agents & Workflows</Typography>
    <Typography sx={{ mb: 2 }}>16+ specialized agents configured in <Typography component="code" sx={{ fontSize: '0.875rem' }}>src/mastra/agents/</Typography> and orchestrated through workflows in <Typography component="code" sx={{ fontSize: '0.875rem' }}>src/mastra/workflows/</Typography>.</Typography>
    <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: 'repeat(2, 1fr)' }, gap: 3, mb: 3 }}>
      <Card variant="outlined">
        <CardHeader>
          <CardTitle sx={{ fontSize: '0.875rem' }}>Core RAG Agents</CardTitle>
        </CardHeader>
        <CardContent>
          <Box component="ul" sx={{ m: 0, pl: 2, '& li': { mb: 1, fontSize: '0.875rem' } }}>
            <li><Badge variant="soft" sx={{ mr: 1 }}>retrieve</Badge>Document retrieval with access control</li>
            <li><Badge variant="soft" sx={{ mr: 1 }}>rerank</Badge>Result relevance ranking</li>
            <li><Badge variant="soft" sx={{ mr: 1 }}>answerer</Badge>Response generation</li>
            <li><Badge variant="soft" sx={{ mr: 1 }}>verifier</Badge>Content verification & security</li>
          </Box>
        </CardContent>
      </Card>
      <Card variant="outlined">
        <CardHeader>
          <CardTitle sx={{ fontSize: '0.875rem' }}>Advanced Agents</CardTitle>
        </CardHeader>
        <CardContent>
          <Box component="ul" sx={{ m: 0, pl: 2, '& li': { mb: 1, fontSize: '0.875rem' } }}>
            <li><Badge variant="soft" sx={{ mr: 1 }}>research</Badge>Deep research capabilities</li>
            <li><Badge variant="soft" sx={{ mr: 1 }}>report</Badge>Report generation</li>
            <li><Badge variant="soft" sx={{ mr: 1 }}>copywriter</Badge>Content optimization</li>
            <li><Badge variant="soft" sx={{ mr: 1 }}>evaluation</Badge>Quality assessment</li>
            <li><Badge variant="soft" sx={{ mr: 1 }}>editor</Badge>Content editing</li>
            <li><Badge variant="soft" sx={{ mr: 1 }}>roadmap</Badge>Product planning</li>
          </Box>
        </CardContent>
      </Card>
    </Box>
  ...
  <TabsContent value="storage">
    ...
    <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: 'repeat(2, 1fr)' }, gap: 3, mb: 3 }}>
      ...
      <Card variant="outlined">
        ...
        <CardContent>
          <Box component="ul" sx={{ m: 0, pl: 2, '& li': { mb: 1, fontSize: '0.875rem', display: 'flex', alignItems: 'center' } }}>
            <li><CheckCircle sx={{ fontSize: 12, color: 'success.main', mr: 1 }} />1568D embeddings</li>
