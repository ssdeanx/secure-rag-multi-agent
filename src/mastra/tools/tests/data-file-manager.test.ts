...
vi.mock('path', () => ({
    ...
    join: vi.fn((...args: string[]) => {
        if (args[0] === '/home/sam/mastra-governed-rag' && args[1] === 'docs/data') {
...
describe('Data File Manager Tools', () => {
    ...
    beforeEach(() => {
        ...
        mockPath.resolve.mockImplementation((...args: string[]) => {
            ...
            if (args[0] === '/home/sam/mastra-governed-rag/docs/data' && args[1] === 'testfile.txt') {
                return '/home/sam/mastra-governed-rag/docs/data/testfile.txt'
            }
            if (args[0] === '/home/sam/mastra-governed-rag/docs/data' && args[1] === '../outside.txt') {
                return '/home/sam/mastra-governed-rag/outside.txt'
            }
            if (args[0] === '/home/sam/mastra-governed-rag/docs/data' && args[1] === 'subdir/testfile.txt') {
                return '/home/sam/mastra-governed-rag/docs/data/subdir/testfile.txt'
            }
            if (args[0] === '/home/sam/mastra-governed-rag/docs/data' && args[1] === 'testdir') {
                return '/home/sam/mastra-governed-rag/docs/data/testdir'
            }
            if (args[0] === '/home/sam/mastra-governed-rag/docs/data' && args[1] === 'docs/data') {
                return '/home/sam/mastra-governed-rag/docs/data'
            }
            if (args[0] === '/home/sam/mastra-governed-rag/docs/data' && args[1] === 'source.txt') {
                return '/home/sam/mastra-governed-rag/docs/data/source.txt'
            }
            if (args[0] === '/home/sam/mastra-governed-rag/docs/data' && args[1] === 'dest.txt') {
                return '/home/sam/mastra-governed-rag/docs/data/dest.txt'
            }
            if (args[0] === '/home/sam/mastra-governed-rag/docs/data' && args[1] === 'subdir/dest.txt') {
                return '/home/sam/mastra-governed-rag/docs/data/subdir/dest.txt'
            }
            if (args[0] === '/home/sam/mastra-governed-rag/docs/data' && args[1] === 'archive') {
        ...
        setTimeout(() => { process.cwd = originalCwd }, 0)
        mockPath.dirname.mockImplementation((p: string) => {
            if (p === '/home/sam/mastra-governed-rag/docs/data/subdir/testfile.txt') { return '/home/sam/mastra-governed-rag/docs/data/subdir' }
            if (p === '/home/sam/mastra-governed-rag/docs/data/subdir/dest.txt') { return '/home/sam/mastra-governed-rag/docs/data/subdir' }
            if (p === '/home/sam/mastra-governed-rag/docs/data/backups/testfile.txt_2025-10-06T10-41-41-029Z') { return '/home/sam/mastra-governed-rag/docs/data/backups' }
            return '/home/sam/mastra-governed-rag/docs/data'
        })
        mockPath.basename.mockImplementation((p: string) => {
            if (p === 'source.txt') { return 'source.txt' }
            if (p === '/home/sam/mastra-governed-rag/docs/data/source.txt') { return 'source.txt' }
            return 'testfile.txt'
        })
        mockPath.relative.mockImplementation((from: string, to: string) => {
            if (from === '/home/sam/mastra-governed-rag/docs/data') {
                if (to === '/home/sam/mastra-governed-rag/docs/data/test1.txt') { return 'test1.txt' }
                if (to === '/home/sam/mastra-governed-rag/docs/data/test2.txt') { return 'test2.txt' }
                if (to === '/home/sam/mastra-governed-rag/docs/data/file1.txt') { return 'file1.txt' }
                if (to === '/home/sam/mastra-governed-rag/docs/data/testfile.txt') { return 'testfile.txt' }
            }
            return 'testfile.txt'
        })
    })
    ...
    describe('readDataFileTool', () => {
        it('should read file content successfully', async () => {
            ...
            mockFs.realpath.mockResolvedValue('/home/sam/mastra-governed-rag/docs/data/testfile.txt')
            ...
            expect(mockFs.realpath).toHaveBeenCalledWith('/home/sam/mastra-governed-rag/docs/data/testfile.txt')
            expect(mockFs.readFile).toHaveBeenCalledWith('/home/sam/mastra-governed-rag/docs/data/testfile.txt', 'utf-8')
        })

        it('should throw error for path outside data directory', async () => {
            mockFs.realpath.mockResolvedValue('/home/sam/mastra-governed-rag/outside.txt')

            await expect(readDataFileTool.execute({
    ...
    describe('writeDataFileTool', () => {
        it('should write file content successfully', async () => {
            ...
            expect(mockFs.writeFile).toHaveBeenCalledWith('/home/sam/mastra-governed-rag/docs/data/testfile.txt', 'new content', 'utf-8')
        })

        it('should create directory if it does not exist', async () => {
            mockFs.realpath.mockResolvedValue('/home/sam/mastra-governed-rag/docs/data/subdir/testfile.txt')
            mockFs.mkdir.mockResolvedValue(undefined)
            mockFs.writeFile.mockResolvedValue(undefined)

            await writeDataFileTool.execute({
                context: { fileName: 'subdir/testfile.txt', content: 'content' },
                runtimeContext: mockRuntimeContext,
                tracingContext: mockTracingContext
            })

            expect(mockFs.mkdir).toHaveBeenCalledWith('/home/sam/mastra-governed-rag/docs/data/subdir', { recursive: true })
        })

        it('should throw error for invalid directory path', async () => {
            mockFs.realpath.mockResolvedValue('/home/sam/mastra-governed-rag/outside/testfile.txt')

            await expect(writeDataFileTool.execute({
    ...
    describe('deleteDataFileTool', () => {
        it('should delete file successfully', async () => {
            ...
            expect(mockFs.unlink).toHaveBeenCalledWith('/home/sam/mastra-governed-rag/docs/data/testfile.txt')
        })

        it('should throw error for path outside data directory', async () => {
            // Path validation happens in validateDataPath
            await expect(deleteDataFileTool.execute({
                context: { fileName: '../outside.txt' },
                runtimeContext: mockRuntimeContext,
                tracingContext: mockTracingContext
            })).rejects.toThrow('Access denied')
    ...
    describe('listDataDirTool', () => {
        it('should list directory contents successfully', async () => {
            ...
            expect(mockFs.readdir).toHaveBeenCalledWith('/home/sam/mastra-governed-rag/docs/data/testdir')
        })
        ...
        it('should use default path when dirPath is not provided', async () => {
            ...
            expect(result).toEqual(mockContents)
            expect(mockFs.readdir).toHaveBeenCalledWith('/home/sam/mastra-governed-rag/docs/data')
        })
    })
    ...
    describe('copyDataFileTool', () => {
        it('should copy file successfully', async () => {
            ...
            expect(result).toBe('File source.txt copied to dest.txt successfully.')
            expect(mockFs.copyFile).toHaveBeenCalledWith('/home/sam/mastra-governed-rag/docs/data/source.txt', '/home/sam/mastra-governed-rag/docs/data/dest.txt')
        })
        ...
        it('should create destination directory if needed', async () => {
            ...
            await copyDataFileTool.execute({
                context: { sourceFile: 'source.txt', destFile: 'subdir/dest.txt' },
                runtimeContext: mockRuntimeContext,
                tracingContext: mockTracingContext
            })
    ...
    describe('moveDataFileTool', () => {
        it('should move file successfully', async () => {
            ...
            expect(result).toBe('File source.txt moved to dest.txt successfully.')
            expect(mockFs.rename).toHaveBeenCalledWith('/home/sam/mastra-governed-rag/docs/data/source.txt', '/home/sam/mastra-governed-rag/docs/data/dest.txt')
        })
    })
    ...
    describe('searchDataFilesTool', () => {
        it('should search files by name successfully', async () => {
            const mockItems = [
                { name: 'test1.txt', isDirectory: () => false, isFile: () => true },
                { name: 'test2.txt', isDirectory: () => false, isFile: () => true },
        ...
        it('should throw error for pattern too long', async () => {
            ...
            await expect(searchDataFilesTool.execute({
    ...
    describe('createDataDirTool', () => {
        it('should create directory successfully', async () => {
            ...
            expect(mockFs.mkdir).toHaveBeenCalledWith('/home/sam/mastra-governed-rag/docs/data/newdir', { recursive: true })
        })
    })
    ...
    describe('removeDataDirTool', () => {
        it('should remove empty directory successfully', async () => {
            ...
            expect(mockFs.rmdir).toHaveBeenCalledWith('/home/sam/mastra-governed-rag/docs/data/emptydir')
        })

        it('should throw error for non-empty directory', async () => {
            mockFs.readdir.mockResolvedValue(['file.txt'])

            await expect(removeDataDirTool.execute({
    ...
    describe('archiveDataTool', () => {
        it('should archive file successfully', async () => {
            ...
            // Mock fs imports
            const mockCreateReadStream = vi.fn().mockReturnValue(mockSourceStream)
            const mockCreateWriteStream = vi.fn().mockReturnValue(mockArchiveStream)
            ...
            expect(result).toBe('File source.txt archived to archive.gz successfully.')
    ...
    describe('backupDataTool', () => {
        it('should create backup successfully', async () => {
            ...
            expect(mockFs.cp).toHaveBeenCalledWith('/home/sam/mastra-governed-rag/docs/data/source.txt', expect.stringContaining('source.txt_'), { recursive: true })
        })
        ...
        it('should use custom backup directory', async () => {
            ...
            expect(mockFs.cp).toHaveBeenCalledWith('/home/sam/mastra-governed-rag/docs/data/source.txt', expect.stringContaining('mybackups/'), { recursive: true })
        })
    })
})
