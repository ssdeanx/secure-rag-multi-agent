...
describe('mastraChunker', () => {
  ...
  it('should successfully chunk document with recursive strategy', async () => {
    ...
    const result = await mastraChunker.execute({
      context: {
        documentContent: 'This is a test document with multiple sentences. This is the second sentence.',
        documentMetadata: {},
        chunkingStrategy: 'recursive',
        chunkSize: 512,
        chunkOverlap: 50,
  ...
  it('should handle different chunking strategies', async () => {
    ...
    const strategies = ['character', 'token', 'markdown', 'semantic-markdown', 'html', 'json', 'latex', 'sentence'];
