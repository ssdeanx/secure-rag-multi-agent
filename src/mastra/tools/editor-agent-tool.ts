...
export const editorTool = createTool({
  id: "editor-agent",
  description: "Calls the editor agent to edit and improve content across multiple formats including blog posts, technical documentation, business communications, creative writing, and general content.",
  inputSchema: z.object({
    content: z.string().describe("The content to be edited"),
    contentType: z.enum(["blog", "technical", "business", "creative", "general"]).optional().describe("The type of content being edited (defaults to 'general')"),
    instructions: z.string().optional().describe("Specific editing instructions or focus areas"),
    tone: z.enum(["professional", "casual", "formal", "engaging", "technical"]).optional().describe("Desired tone for the edited content")
  }),
