...
>
export type TodoListMessage = CustomMessage<
    'todo-list',
    {
...
export const MessageResponseSchema = z.object({
    type: z
        .literal('message')
        .describe('Action type for adding messages to chat'),
    role: z
...
export const ProgressUpdateResponseSchema = z.object({
    type: z
        ...
        .describe('Action type for progress indicators'),
...
export type ProgressUpdateResponse = z.infer<
    typeof ProgressUpdateResponseSchema
>
export type ActionResponse = z.infer<typeof ActionResponseSchema>
export type ExecuteFunctionResponse = z.infer<
    typeof ExecuteFunctionResponseSchema
>
