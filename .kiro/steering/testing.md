...
describe('AuthenticationService', () => {
    ...
    describe('verifyJWT', () => {
        ...
        test('should reject empty JWT', async () => {
            await expect(AuthenticationService.verifyJWT('')).rejects.toThrow(
...
describe('Agents', () => {
    describe('Identity Agent', () => {
        test('should extract JWT claims using tool', async () => {
            ...
            jest.spyOn(AuthenticationService, 'verifyJWT').mockResolvedValue(
                mockClaims
            )
        ...
        test('should handle invalid JWT', async () => {
            ...
            jest.spyOn(AuthenticationService, 'verifyJWT').mockRejectedValue(
    ...
    describe('Answerer Agent', () => {
        ...
        test('should handle no contexts', async () => {
            ...
            expect(result.object.answer).toContain(
...
describe('Security Tests', () => {
    describe('Role-Based Access Control', () => {
        ...
        test('should enforce tenant isolation', async () => {
            ...
            const matchesTenant = allowTags.some(
                (tag) =>
    ...
    describe('Data Leakage Prevention', () => {
        ...
        test('should verify answer uses only provided contexts', async () => {
            ...
            const verification = await verifierAgent.generate(
                JSON.stringify({
                    answer,
...
describe('Performance Tests', () => {
    ...
    test('should handle large document indexing', async () => {
        ...
        console.log(
            `Indexed ${largeDocuments.length} documents in ${duration}ms`
        )
    })
...
export function setupMocks(): void {
    jest.spyOn(AuthenticationService, 'verifyJWT').mockImplementation(
        mockAuthenticationService.verifyJWT
    )
    jest.spyOn(
        AuthenticationService,
        'generateAccessPolicy'
    ).mockImplementation(mockAuthenticationService.generateAccessPolicy)
}
