            ...
            <Box sx={{ maxWidth: '1400px', mx: 'auto' }}>
                ...
                >
                    ...
                    >
                        ...
                        <Typography
                            level="h2"
                            sx={{ fontSize: '2rem', fontWeight: 800, mb: 1 }}
                        >
                            {docCount <= 1000
                                ? 'Free'
                                : docCount <= 50000
                ...
                >
                    <Typography level="h3" sx={{ mb: 4, fontWeight: 700 }}>
                        Questions?
                    </Typography>
                    <Typography
                        level="body-lg"
