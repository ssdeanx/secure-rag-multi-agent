                ...
                <div className="mb-16 text-center">
                    ...
                    <div className="max-w-4xl mx-auto mb-8">
                        <p className="text-lg text-muted-foreground leading-relaxed">
                            Complete guide to building secure, enterprise-grade
                            RAG applications with role-based access control,
                            multi-agent orchestration, and zero-trust security
                            using the Mastra AI framework.
                        </p>
                    </div>
                    ...
                    <TabsContent value="overview" className="space-y-8">
                                ...
                                <CardContent className="space-y-4">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-muted-foreground">
                                                Every query is authenticated and
                                                authorized at multiple pipeline
                                                stages
                                            </p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-muted-foreground">
                                                6 specialized AI agents work
                                                together for secure knowledge
                                                retrieval
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <Card className="border-2 border-primary/20">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    High-level overview of the Governed RAG
                                    pipeline
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                    ...
                    <TabsContent value="quickstart" className="space-y-6">
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                ...
                                <CardContent>
                                    <div className="bg-muted p-4 rounded-lg mb-4">
                                        <code className="text-sm block">
                                            git clone
                                            https://github.com/ssdeanx/governed-rag-ai.git
                                            <br />
                                            cd governed-rag-ai
                                            <br />
                                            npm install
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Clone the repository and install all
                                        dependencies including Next.js, Mastra,
                            ...
                            <Card className="border-2 border-blue-500/20 bg-blue-500/5">
                                ...
                                <CardContent>
                                    ...
                                    <div className="space-y-2 text-sm">
                                        ...
                                        <div>
                                            <strong>JWT_SECRET:</strong> Random
                                            secret for JWT signing
                                        </div>
                                        <div>
                                            <strong>QDRANT_URL:</strong> Vector
                                            database endpoint
                                        </div>
                                    </div>
                                </CardContent>
                            ...
                            <Card className="border-2 border-purple-500/20 bg-purple-500/5">
                                ...
                                <CardContent>
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Start Qdrant vector database and the
                                        Next.js development server. Access at
                                        http://localhost:3000
                                    </p>
                                </CardContent>
                            </Card>
                        ...
                        <Card className="border-2 border-orange-500/20 bg-orange-500/5">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Load sample documents with security
                                    classifications
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                        ...
                        <Alert className="border-2 border-primary/20">
                            ...
                            <AlertDescription>
                                <strong>Success!</strong> Your Governed RAG
                                system is now running. Visit{' '}
                                <code>http://localhost:3000</code> to start
                                chatting with your secure knowledge base.
                            </AlertDescription>
                        </Alert>
                    </TabsContent>
                    ...
                    <TabsContent value="security" className="space-y-6">
                        <Card className="border-2 border-primary/20">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Hierarchical role system with automatic
                                ...
                                <div className="space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                        ...
                                        <div className="p-4 border-2 border-yellow-200 bg-yellow-50 dark:bg-yellow-950 rounded-lg">
                                            ...
                                            <p className="text-xs">
                                                Department-specific read access
                                            </p>
                                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="p-4 border border-yellow-200 bg-yellow-50 dark:bg-yellow-950 rounded-lg">
                                            ...
                                            <p className="text-sm text-yellow-600 dark:text-yellow-400">
                                                Department-specific or sensitive
                                                internal documents
                                            </p>
                                            <div className="mt-2">
                                                <Badge
                            ...
                            <Card className="border-2 border-primary/20">
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        JWT-based security with multi-stage
                                        validation
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                    ...
                    <TabsContent value="api" className="space-y-6">
                        <Card className="border-2 border-primary/20">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Secure streaming query endpoint with
  ...
  {"docId": "finance-policy-001", "source": "Finance Department Policy Manual"}
                        ...
                        <Card className="border-2 border-accent/20">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Index documents from corpus with automatic
  ...
  "jwt": "optional-jwt-token"
                    ...
                    <TabsContent value="architecture" className="space-y-6">
                        <Card className="border-2 border-primary/20">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    6 specialized AI agents working together for
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                        ...
                                        <div className="p-4 border-2 border-green-200 bg-green-50 dark:bg-green-950 rounded-lg">
                                            ...
                                            <p className="text-sm text-green-600 dark:text-green-400 mb-2">
                                                Convert claims to access filters
                                                and permissions
                                            </p>
                                            <Badge
                                                variant="secondary"
                                        ...
                                        <div className="p-4 border-2 border-yellow-200 bg-yellow-50 dark:bg-yellow-950 rounded-lg">
                                            ...
                                            <p className="text-sm text-yellow-600 dark:text-yellow-400 mb-2">
                                                Secure document retrieval with
                                                access filtering
                                            </p>
                                            <Badge
                                                variant="secondary"
                                        ...
                                        <div className="p-4 border-2 border-red-200 bg-red-50 dark:bg-red-950 rounded-lg">
                                            ...
                                            <p className="text-sm text-red-600 dark:text-red-400 mb-2">
                                                Generate answers from authorized
                                                contexts only
                                            </p>
                                            <Badge
                                                variant="secondary"
                    ...
                    <TabsContent value="examples" className="space-y-6">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <Card className="border-2 border-green-500/20 bg-green-500/5">
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Role: finance.viewer, employee, public
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                                    <div className="space-y-4">
                        ...
                        <Card className="border-2 border-primary/20">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Try the system with different roles and
                                    queries
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <div className="bg-muted p-6 rounded-lg">
                                    <div className="text-center mb-4">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                                            <div className="bg-background p-3 rounded">
                                                <code>
                                                    npm run cli demo -- --role
                                                    finance.viewer
                                                </code>
                                                <p className="text-xs text-muted-foreground mt-1">
                                                    Finance team simulation
                                                </p>
                                            </div>
                                            <div className="bg-background p-3 rounded">
                                                <code>
                                    ...
                                    <Alert className="border-2 border-accent/20">
                                        ...
                                        <AlertDescription>
                                            ...
                                            CLI demo mode to test different user
                                            roles and see how the security
                                            filtering works in practice.
                                        </AlertDescription>
                                    </Alert>
                                </div>
                            </CardContent>
                ...
                <div className="mt-16 pt-8 border-t border-primary/20">
                    <div className="text-center">
                        ...
                        <p className="text-sm text-muted-foreground">
                            © 2025 Governed RAG. Built with ❤️ using
                            cutting-edge AI and security technologies.
                        </p>
                    </div>
                </div>
            </div>
