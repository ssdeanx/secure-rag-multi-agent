...
export async function generateMetadata({
    ...
    if (cached) {
        return metadataFromFrontmatter(
            {
                title:
                    typeof cached.frontmatter.title === 'string'
                        ? cached.frontmatter.title
                        : undefined,
                description:
                    typeof cached.frontmatter.description === 'string'
                        ? cached.frontmatter.description
                        : undefined,
    ...
    // Fallback generic
    return metadataFromFrontmatter(
        { title: 'Documentation', description: 'Governed RAG documentation' },
        `/docs/${slug === 'index' ? '' : slug}`
    )
}
...
export async function generateStaticParams() {
    ...
    files
        ...
        .forEach((file: string) => {
            ...
            if (
                slugPath.length > 0 &&
                slugPath[slugPath.length - 1] === 'index'
            ) {
