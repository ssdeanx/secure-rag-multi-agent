                            ...
                            <div className="space-y-8">
                                <div className="text-center py-8 sm:py-12 lg:py-16">
                                    ...
                                    <p className="text-muted-foreground max-w-2xl mb-6 sm:mb-8 text-sm sm:text-base mx-auto">
                                        ...
                                        enterprise-grade security for RAG
                                        applications. Select a role below to see
                                        how different users access different
                                        information.
                                    </p>
                                </div>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mt-8 sm:mt-12 grid-center animated-gradient-subtle p-4 rounded-lg">
                                    ...
                                    >
                                        Department-specific information for
                                        authorized roles
                                    </FeatureCard>
                                    ...
                                    >
                                        Sensitive data requiring admin
                                        privileges and step-up auth
                                    </FeatureCard>
                                </div>
                            </div>
                        )}
