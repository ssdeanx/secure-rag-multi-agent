...
**Bundle Size**: Despite adding Joy UI, our initial bundle actually *decreased* by ~15KB (gzipped) because:
...
Once we migrated a component to Joy, we could often *delete* custom accessibility code. Joy handles it better than we did manually.
...
*Have questions about our migration? Found this helpful? Let us know on [GitHub Discussions](https://github.com/ssdeanx/governed-rag-ai/discussions).*
