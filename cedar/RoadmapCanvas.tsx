...
import type { Connection, NodeChange, Node } from 'reactflow'
import ReactFlow, {
    addEdge,
    Background,
    ConnectionLineType,
...
import { useCedarRoadmap } from '../app/protected/cedar-os/hooks'
            ...
            {selectedNodes.length > 0 && (
                <div className="absolute top-4 right-4 bg-white/90 backdrop-blur rounded-lg p-3 shadow-lg border">
                    ...
                    <p className="text-xs text-gray-500 mt-2">
                        💡 Ask Cedar about these selected features!
                    </p>
                </div>
            )}
        </div>
