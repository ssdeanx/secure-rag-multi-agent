...
function FeatureNodeComponent({
            ...
            return nds.map((n) =>
                n.id === id
                    ? {
                          ...
                          data: {
                              ...n.data,
                              comments: [...n.data.comments, newComment],
                          },
                      }
                    : n
            )
    ...
    const commitTitle = () => {
        setNodes((nds) => {
            return nds.map((n) =>
                n.id === id
                    ? { ...n, data: { ...n.data, title: titleValue } }
                    : n
            )
        })
    }
        ...
        setNodes((nds) => {
            return nds.map((n) =>
                n.id === id
                    ? {
                          ...n,
                          data: { ...n.data, description: descriptionValue },
                      }
                    : n
            )
        })
    ...
    const handleNodeTypeChange = (newNodeType: NodeType) => {
        setNodes((nds) => {
            return nds.map((n) =>
                n.id === id
                    ? { ...n, data: { ...n.data, nodeType: newNodeType } }
                    : n
            )
        })
    }
