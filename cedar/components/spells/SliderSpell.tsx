...
const CustomSlider: React.FC<{
    ...
    const displayText = useMemo(() => {
        if (currentRange?.range.text) {
            return currentRange.range.text.replace(
                '${value}',
                `${value}${unit}`
            )
        }
                    ...
                    <div className="absolute -top-8 left-1/2 transform -translate-x-1/2">
                        <div
                            ...
                            style={{
                                ...
                                borderColor:
                                    currentRange?.range.color ?? 'transparent',
                                borderWidth: currentRange?.range.color
                                    ? '1px'
                                    : '0',
                                borderStyle: 'solid',
                            }}
