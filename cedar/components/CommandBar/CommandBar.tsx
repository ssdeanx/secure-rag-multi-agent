...
const COLOR_CLASSES = {
    ...
    green: 'bg-green-50 dark:bg-green-950/40 hover:bg-green-100 dark:hover:bg-green-950/60 data-[selected=true]:bg-green-200 dark:data-[selected=true]:bg-green-800/60',
    purple: 'bg-purple-50 dark:bg-purple-950/40 hover:bg-purple-100 dark:hover:bg-purple-950/60 data-[selected=true]:bg-purple-200 dark:data-[selected=true]:bg-purple-800/60',
    orange: 'bg-orange-50 dark:bg-orange-950/40 hover:bg-orange-100 dark:hover:bg-orange-950/60 data-[selected=true]:bg-orange-200 dark:data-[selected=true]:bg-orange-800/60',
    ...
    amber: 'bg-amber-50 dark:bg-amber-950/40 hover:bg-amber-100 dark:hover:bg-amber-950/60 data-[selected=true]:bg-amber-200 dark:data-[selected=true]:bg-amber-800/60',
    ...
    indigo: 'bg-indigo-50 dark:bg-indigo-950/40 hover:bg-indigo-100 dark:hover:bg-indigo-950/60 data-[selected=true]:bg-indigo-200 dark:data-[selected=true]:bg-indigo-800/60',
    white: 'bg-white dark:bg-gray-50 hover:bg-gray-100 dark:hover:bg-gray-200 data-[selected=true]:bg-gray-200 dark:data-[selected=true]:bg-gray-800',
} as const
...
export const CommandBar: React.FC<CommandBarProps> = ({
    ...
    const isLatestMessageHidden = React.useMemo(() => {
        ...
        return (
            messageIndex <= baselineMessageIndex || hasUserMessagesSinceBaseline
        )
    }, [
        latestMessage,
        messages,
                            ...
                            <div className="">
                                {filteredContents.fixedBottomGroup.heading && (
                                    <div className="text-xs font-medium text-muted-foreground mb-2 px-2">
                                        {
                                            filteredContents.fixedBottomGroup
                                                .heading
                                        }
                                    </div>
                                )}
                                <div className="flex gap-1">
                                    {filteredContents.fixedBottomGroup.items.map(
                                        (item) => (
                                            <button
                                                key={item.id}
                                                onMouseDown={() => {
