import type { HumanInTheLoopMessage } from 'cedar-os'
import { useVoice, cn, useCedarStore } from 'cedar-os'
                ...
                {voice.isListening || voice.isSpeaking ? (
                    ...
                    <div className="py-2 items-center justify-center w-full">
                        <HumanInTheLoopIndicator
                            state={
                                (latestMessage as HumanInTheLoopMessage).state
                            }
                        />
                    </div>
                ) : (
